...
Split by spaces, filter empty strings, reverse the array, and join with single space.

## Complexity Analysis

- **Time Complexity:** O(n) - Linear scan and operations
- **Space Complexity:** O(n) - Space for split array
